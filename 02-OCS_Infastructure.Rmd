...
Data included in the GitHub repository is available in multiple formats to enable modular use of the case studies as described below. 
```{r, fig.align='center', echo = FALSE, fig.alt= "Diagram illustrating how to access case studies and their source material through the Open Case Studies website and search table"}
knitr::include_graphics('assets/OCS_GitHub_Data_Directory_Diagram_Final.png', dpi = NA)
```

To use the case study data, you can download the GitHub repository directly or use the OCSdata R package described below. 
