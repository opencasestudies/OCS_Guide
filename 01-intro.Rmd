...
| ------- | ---------------- |
| Motivation | Motivating fgure and text at the start of the case study |
| Main questions | Scientifc question(s) |
...
knitr::include_graphics('assets/TOC_scroll.gif', dpi = NA)
```
