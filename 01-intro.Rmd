...
Case studies of the Open Case Studies project provide independent learners and educators with resources for data science education. The case studies use realistic data from sources that are used for actual research or public health initiatives. Each case study addresses a timely and interesting topic, in an effort so that learners find the material more engaging and relevant.

Case studies of the project are not intended to show all aspects of the research process, and we do not claim that the analyses show most appropriate way to analyze a given data set, however they are intended to demonstrate the decision making process of real data analyses, to show examples of applications of data methods and to provide context for when such methods could be applied and how they might be used to generally glean information from data.

The goal of the project overall is to provide instructors with resources to use in the classroom so that they can make their instruction more hands on while covering interesting and relevant topics, while also providing stand-alone resources to students to supplement their course instruction and for independent learners to expand their data science knowledge. 
...
knitr::include_graphics('resources/images/ocs_anatomy.png', dpi = NA)
```
...
knitr::include_graphics('resources/images/OCS_TOC_anatomy.png', dpi = NA)
```
...
```{r, fig.align='center', echo = FALSE, fig.alt= "Moving GIF image illustrating how to navigate a case study with the table of contents"}
knitr::include_graphics('resources/images/TOC_scroll.gif', dpi = NA)
```
...
If you have any questions, suggestions for improvement for individual case studies, or you have an idea for a case study and would like to work with us, you can contact us through email using this form:
...
Also, see the final chapter for information on submitting case studies to our collection.
