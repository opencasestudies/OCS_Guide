...
Case studies of the project are not intended to show all aspects of the research process, and we do not claim that the analyses show the most appropriate way to analyze a given data set, however case studies are intended to demonstrate the decision making process of real data analyses, to show examples of applications of data methods and to provide context for when such methods could be applied and how these methods be used to generally glean information from data. We hope to demonstrate best practices for being data cleaning and wrangling, reproducible work, as well as effective data science communication. 
