...
```{r, fig.align='center', echo = FALSE, fig.alt= "Open Case Study graphic stating that open case studies provide real-world data analysis examples", out.width="100%"}
ottrpal::include_slide("https://docs.google.com/presentation/d/17DhSo5YTKzP9bl-zfduezsyfItZRzJYmIgczUvr-Cw0/edit#slide=id.g107fd794960_0_154")
```
...
```{r, fig.align='center', echo = FALSE, fig.alt= "Moving GIF image illustrating how to navigate a case study with the table of contents", out.width="100%"}
