...
*short explanation of case study structure: Rstudio projects written in .Rmds, knitted to HTML and hosted on GitHub
*tutorial on Rmd's and knitting in RStudio
...
*tutorial on how to create a case study using makecasestudies webapp
