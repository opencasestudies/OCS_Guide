...
```{r, fig.align='center', echo = FALSE, fig.alt= "Moving image (GIF) showing a user skipping to the data analysis section of a case study", out.width="100%"}
knitr::include_graphics('resources/images/skip_section.gif')
```
...
```{r, fig.align="center", fig.alt = "video", echo=FALSE, out.width="100%"}
knitr::include_url("https://www.youtube.com/watch?v=Dd4KASCIsNc")
```
