...
- **Data:**
  ...
  - The next two data sub-folders are optional and used as needed: 
    ...
    - If there are any raw data files from your source that are not used in the case study analysis, but could be analysed in a similar fashion, please include these in the "extra" sub-folder. 
