...
- Converted the case study into a [slide deck](https://cogs137.github.io/website/lecslides/16-cs2-data.html#1) ([Practical Data Science in R](https://cogs137.github.io/website/) taught by Dr. Shannon Ellis at University of California Santa Barbara)
...
```{r, fig.align='center', echo = FALSE, fig.alt= "A slide from the class taught by Dr Ellis showing the use of the OCSdata package"}

knitr::include_graphics('resources/images/shannon-casestudy.png')
```
