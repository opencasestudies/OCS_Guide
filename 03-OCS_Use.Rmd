...
```{r, fig.align='center', echo = FALSE, fig.alt= "A slide from the class taught by Dr Ellis showing the use of the OCSdata package", out.width="100%"}
...
knitr::include_url("https://www.youtube.com/watch?v=3iFtuDK0o-M")
```
